...
while loopnum < int(many):  # loop
    result_str = ''.join((random.choice('1234567890') for i in range(3)))  # generate code
    result_str2 = ''.join((random.choice('1234567890') for i in range(3)))  # generate code
    result_str3 = ''.join((random.choice('1234567890') for i in range(3)))
    result_str4 = ''.join((random.choice('1234567890') for i in range(3)))
